          ...
          children: <Widget>[
              ...
              style: TextStyle(
                ...
                Navigator.push(context,
                  MaterialPageRoute(builder: (context)=>SingUp(UserType: "Lector")));},
                style: ElevatedButton.styleFrom(
                  backgroundColor: Color(0xff2E4D4D),
                  padding: EdgeInsets.symmetric(horizontal: 40, vertical: 15)),
              child: Text("Como Lector", style: TextStyle(
                fontSize: 20,
                color: Colors.white
              ),),),
              ...
              ElevatedButton(onPressed: (){
                Navigator.push(context,
                  MaterialPageRoute(builder: (context)=>SingUp(UserType: "Autor")));},
                style: ElevatedButton.styleFrom(
                  backgroundColor: Color(0xff2E4D4D),
                  padding: EdgeInsets.symmetric(horizontal: 40, vertical: 15)),
              child: Text("Como Autor", style: TextStyle(
                fontSize: 20,
                color: Colors.white
              ),),),
              SizedBox(height: 10), //todo separación de botones
              ElevatedButton(onPressed: (){
                Navigator.push(context,
                  MaterialPageRoute(builder: (context)=>SingUp(UserType: "Editorial")));},
                style: ElevatedButton.styleFrom(
                  backgroundColor: Color(0xff2E4D4D),
                  padding: EdgeInsets.symmetric(horizontal: 40, vertical: 15)),
              child: Text("Como Editorial", style: TextStyle(
                fontSize: 20,
                color: Colors.white
              ),),),
          ]))
