...
class ForosAutores extends StatefulWidget {
  const ForosAutores({super.key});

  @override
  State<ForosAutores> createState() => _ForosAutoresState();
}

class _ForosAutoresState extends State<ForosAutores> with SingleTickerProviderStateMixin {
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => const NotificacionesA()), // Navega a la pantalla de notificaciones
              );
            },
          ),
        ],
          ...
          children: <Widget>[
            ...
            ListTile(
              ...
              onTap: () {
                ...
                Navigator.push(context, MaterialPageRoute(builder: (context) => const CatalogoA())); // Navigate to Configuracion
              },
            ),
            ListTile(
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.pop(context); // Close the drawer
                Navigator.push(context, MaterialPageRoute(builder: (context) => const ConfiguracionAut())); // Navigate to Configuracion
              },
            ),
            const Divider(), // Divisor visual
            ListTile(
